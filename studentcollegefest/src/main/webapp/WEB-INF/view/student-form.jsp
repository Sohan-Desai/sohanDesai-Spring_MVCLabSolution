...
<body>
	...
	<div class="registration-form">
		...
		<form action="/studentcollegefest/students/save" method="POST">
			...
			<div>
				<p>Name</p>
				<input type="text" name="name" value="${student.name}" placeholder="Eg: John" required>
			</div>
			<!-- This is a required field -->
			<div>
				<p>Department</p>
				<input type="text" name="department" value="${student.department}" placeholder="Eg: IT" required>
			</div>
			<div>
				<p>Country</p>
