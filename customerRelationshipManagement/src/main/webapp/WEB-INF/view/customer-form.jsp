...
<body>
	...
	<div class="registration-form">
		...
		<form action="/customerRelationshipManagement/customers/save" method="POST">
			...
			<div>
				<p>First Name</p>
				<input type="text" name="firstName" value="${customer.firstName}" placeholder="Eg: John">
			</div>
			<div>
				<p>Last Name</p>
				<input type="text" name="lastName" value="${customer.lastName}" placeholder="Eg: Smith">
			</div>
			<!-- This is a required field -->
			<div>
				<p>Email id</p>
				<input type="email" name="email" value="${customer.email}" placeholder="Eg: john@xyz.com" required>
			</div>
